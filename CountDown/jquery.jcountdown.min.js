    ...
    jCountdown: function() {
        var B = function(b) {
                ...
                this.update = function(a) {
                    if (a) {
                        ...
                        this._intervalId = setInterval(function() {
                                b.frame() == b.totalFrames() ? (clearInterval(b._intervalId),
                                    b.onFinish()) : b.frame(b.frame() + 1)
                            }
            ...
            , D = function(b) {
                ...
                this.frame = function(a) {
                    ...
                    a = this.value() + 1;
                    9 < a && (a = 0);
                    var b = this.frame() / this.totalFrames(), c;
            ...
            , y = function() {
                ...
                this.checkTime = function(b) {
                    ...
                    if (this._time.getTime() < a.getTime() + 6E4 * a.getTimezoneOffset()) {
                        for (a = 0; a < this._days.length; a++)
                            this._days[a].value(0);
                        for (a = 0; a < this._hours.length; a++)
                            this._hours[a].value(0);
                        for (a = 0; a < this._minutes.length; a++)
                            this._minutes[a].value(0);
                        for (a = 0; a < this._seconds.length; a++)
                            this._seconds[a].value(0);
                        this.stop();
                        this.onFinish();
                        return !0
                    }
                ...
                this.start = function() {
                    this.stop();
                    for (var b = 0; b < this._days.length; b++)
                        this._days[b].update();
                    for (b = 0; b < this._hours.length; b++)
                        this._hours[b].update();
                    for (b = 0; b < this._minutes.length; b++)
                        this._minutes[b].update();
                    for (b = 0; b < this._seconds.length; b++)
                        this._seconds[b].update();
                    if (!this.checkTime(!1)) {
                        var a = this;
                ...
                this.stop = function() {
                    ...
                    for (b = 0; b < this._hours.length; b++)
                        this._hours[b].stop();
                    for (b = 0; b < this._minutes.length; b++)
                        this._minutes[b].stop();
                    for (b = 0; b < this._seconds.length; b++)
                        this._seconds[b].stop();
                ...
                this.destroy = function() {
                    for (var b = 0; b < this._days.length; b++)
                        this._days[b].destroy();
                    for (b = 0; b < this._hours.length; b++)
                        this._hours[b].destroy();
                    for (b = 0; b < this._minutes.length; b++)
                        this._minutes[b].destroy();
                    for (b = 0; b < this._seconds.length; b++)
                        this._seconds[b].destroy();
                    this._days = [];
                    this._hours = [];
                    this._minutes = [];
                    this._seconds = [];
        ...
        if (0 < arguments.length) {
            ...
            if (1 == arguments.length && "object" == typeof arguments[0]) {
                ...
                0 < l ? 10 < l && (l = 10) : l = 0;
                var g = 2 < parseInt(e.dayTextNumber, 10) ? parseInt(e.dayTextNumber, 10) : 2, h = !1 != e.displayDay, A = !1 != e.displayHour, z = !1 != e.displayMinute, x = !1 != e.displaySecond, w = !1 != e.displayLabel, e = "function" == typeof e.onFinish ? e.onFinish : function() {}
                    , c, f = "", s = "";
...
/*                if (h) {
                ...
                u && !(jQuery.browser.msie && 10 > j) && (reflectionObject = g.clone(),
                    reflectionObject.addClass("reflection"),
                w && reflectionObject.addClass("displayLabel"),
                100 != r && reflectionObject.css("opacity", r / 100),
                0 != l && reflectionObject.addClass("blur" + l),
                    g = g.add(reflectionObject));
                f = jQuery('<div class="jCountdownContainer"></div>');
                f.append(g);
                q.append(f);
                0 != d && (k = jQuery('<div class="jCountdownScale"></div>'),
                    k.append(g),
                    f.append(k),
                    n = k.width(),
                    p = k.height(),
                    ...
                    f.width(n * d),
                    f.height(p * d),
                    jQuery.browser.msie && 8 >= j ? k.css("zoom", d) : (k.css("transform", l).css("-moz-transform", l).css("-webkit-transform", l).css("-o-transform", l).css("-ms-transform", l),
                        k.css("left", u).css("top", r)));
                j = "";
                d = 0;
                k = [];
                n = [];
                ...
                d = 1;
                for (j = ".group.day>.container.item"; g.find(j + d).length; )
                    k.push(new f(g.find(j + d))),
                        d++;
                d = 1;
                for (j = ".group.hour>.container.item"; g.find(j + d).length; )
                    n.push(new f(g.find(j + d))),
                        d++;
                d = 1;
                for (j = ".group.minute>.container.item"; g.find(j + d).length; )
                    p.push(new f(g.find(j + d))),
                        d++;
                d = 1;
                for (j = ".group.second>.container.item"; g.find(j + d).length; )
                    u.push(new f(g.find(j + d))),
                        d++;
                m.items(k, n, p, u);
                m.onFinish = e;
                m.time(y, t)
            } else if ("string" == typeof arguments[0] && void 0 != m)
                switch (arguments[0]) {
                    case "stop":
                        m.stop();
                        break;
