...
var run = {
    ...
    play: function () {
        var skewing, cloneSkewing, timer, time = 1000, changeBtnTime = 500, imgNum = 5, cloneLeft, type = 0, bol = true;
        ...
        if (imgLength > imgNum) {
            ...
            function move() {
                ...
                timer = setInterval(function () {
                    ...
                    $(".ui-cont").animate({"left": imgLeft + skewing}, changeBtnTime);
                    $(".clone").animate({"left": cloneLeft + skewing}, changeBtnTime);
            ...
            $(".btn a").on("click", function () {
                if ($(this).index()) {
                    ...
                    $(".ui-cont").stop(true, true).animate({"left": imgLeft + skewing}, changeBtnTime);
                    $(".clone").stop(true, true).animate({"left": cloneLeft + skewing}, changeBtnTime);
